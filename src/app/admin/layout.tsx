      ...
      <aside className="w-64 bg-white border-r border-gray-200/80 flex flex-col shadow-xs">
        ...
        <div className="p-4 border-t border-gray-200/80">
          <button 
            ...
            className="w-full flex items-center gap-2 px-3.5 py-2.5 text-xs font-semibold text-rose-600 hover:bg-rose-50 rounded-xl transition-colors cursor-pointer"
          >
            <LogOut size={16} />
            <span>Sign Out</span>
          </button>
